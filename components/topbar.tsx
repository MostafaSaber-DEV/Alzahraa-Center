    ...
    <div className="flex items-center justify-between border-b bg-background p-6">
      <div className="flex max-w-md flex-1 items-center gap-4">
        <div className="relative flex-1">
          ...
          <Input placeholder="Search students, groups, tasks..." className="pl-10" />
        </div>
      </div>
          ...
          <DropdownMenuContent align="end" className="w-80">
            ...
            <DropdownMenuItem>
              <div className="flex flex-col gap-1">
                ...
                <p className="text-xs text-muted-foreground">Sarah Wilson joined Grade 1 class</p>
              </div>
            </DropdownMenuItem>
            <DropdownMenuItem>
              <div className="flex flex-col gap-1">
                <p className="text-sm font-medium">Payment received</p>
                <p className="text-xs text-muted-foreground">Michael Chen paid $380 for Grade 2</p>
              </div>
            </DropdownMenuItem>
            <DropdownMenuItem>
              <div className="flex flex-col gap-1">
                <p className="text-sm font-medium">Class reminder</p>
                <p className="text-xs text-muted-foreground">Grade 3 class starts in 30 minutes</p>
              </div>
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
